            ...
            <div class="col-md-8 col-md-ofset-2">
                <table class="tab-content table table-bordered table-responsive">
                    <tr>
                        ...
                        <td class="auto-style1"><asp:Label ID="countryNameLabel" Text="Country Name" runat="server" /></td>
                        <td><asp:TextBox ID="countryNameTextBox" class="form-control" runat="server"></asp:TextBox></td>
                            <td><asp:Button ID="searchButton" runat="server" class="btn btn-default" Text="Search" OnClick="searchButton_Click" />
                       </td>
                        </div>
                    </tr>
                    <%-- <tr>
                        <div class="form-group">
                        <td><asp:RadioButton ID="countryRadioButton" runat="server" Text="Country" /></td>
                        <td><asp:DropDownList ID="countryDropDownList" class="form-control" runat="server"/></td>
                             <td><asp:Button ID="searchButton" runat="server" class="btn btn-default" Text="Search" OnClick="searchButton_Click" />
                        </td>
                        </div>
                    </tr>--%>
